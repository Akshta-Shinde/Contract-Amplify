...
function LoadingIndexScreen() {
            ...
            return (
                <div className="loading-type-selection">
                    <Radio.Group onChange={loadingOnChange} value={loadingValue}>
                        <Radio value={6001}>{AppConstants.applicable}</Radio>
                        <Radio value={6002}>{AppConstants.notApplicable}</Radio>
                    </Radio.Group>
                </div>
            );
        } catch (ex) {
    ...
    const chargeType = () => {
        console.log("chargeType is",value)
        try {
            return (
                ...
                <div className="notes-view-container">
                    ...
                    <div className='notes-container'>
                        <div className="notes-title">
                            ...
                            <div className='notes-content'>
                                <div>{AppConstants.pricePerConsignment}</div>
        ...
        try {
            return (
                <div className="not-applicable-noteview">
                    <NotesIcon />
                    <div className='content'>{AppConstants.loadingNotApplicable}</div>
                </div>
            );
        } catch (ex) {
    ...
    const contentView = () => {
        console.log(" contentView value is",value)
        try {
            return (
                <div>
                    {value === "VT" &&
    ...
    return (
        <Layout>
            <NavbarLayout>
                <Layout>
                    <SideMenu
                        selectedKey={AppConstants.loading} 
                        menu={null}/>
                    <Content>
                        <TitleContainer 
                        title={AppConstants.loading}
                        screenPath="/unloading"
                        screenPreviousPath="/return-b2cd2c">
                            <div className="loading-screen-container">
                                {loadingType()}
                                <div className="vehicle-chargeType-container">
                                    {loadingValue === 6001 && chargeType()}
                                    {loadingValue === 6002 && notApplicableView()}
                                </div>
                            </div>
                        </TitleContainer>
                    </Content>
